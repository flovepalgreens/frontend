...
export default function Home() {
    ...
    >
      ...
      <div className="w-full bg-green-600 py-4 mt-10 overflow-hidden">
        <div className="flex gap-6 animate-scroll whitespace-nowrap px-4">
          {['ai', 'xr', 'iot'].map((item) => (
            <div key={item} className="min-w-[300px] bg-white rounded-lg ml-40 shadow-lg p-4 text-center">
              <Image 
      ...
      <div className="flex flex-col md:flex-row items-center justify-center w-full py-16 px-10">
        <div className="w-full md:w-1/2 items-center justify-center p-6">
          <h2 className="text-3xl md:text-4xl font-bold ml-50 items-center justify-center text-green-700">Why Choose Flovepal?</h2>
          ...
          <div className="min-w-[300px] m-8 bg-white rounded-lg shadow-lg p-4 text-center">
  ...
  <h2 className="text-4xl font-bold text-center justify-center text-3xl md:text-4xl font-bold items-center ml-180 text-green-700 mb-12">Testimonials</h2>
  
  <div className="w-full flex flex-col gap-12 relative z-10">
    {/* First Testimonial - Left aligned */}
    <div className="flex justify-start ml-50 w-full">
    ...
    <div className="flex w-full ml-150">
      <div className="bg-white p-6 rounded-lg shadow-md relative w-full md:w-2/3 lg:w-1/2">
    ...
    <div className="flex justify-start ml-50 w-full ml-20">
      <div className="bg-white p-6 rounded-lg shadow-md relative w-full md:w-2/3 lg:w-1/2">
